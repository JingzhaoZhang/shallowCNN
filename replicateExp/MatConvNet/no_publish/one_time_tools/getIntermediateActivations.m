function getIntermediateActivations(netLoc, endLayer, dataset)
    ...
    %dataset='CUB';
    %detects={'Marcel2'};
    detects={'classification_with_parts'};
...
%                 'learningRate', [1]*learnW);
        ...
        elseif strcmp(dataset, 'classification_with_parts')
            dataset
            ...
            use448=true;
            endLayer=30; % relu5_3
            netLoc=['/home/yang/exp_data/fv_layer/exp_yang_fv/', ...
            'CUB_VGG_16_LR_compact2_8192_fixW_448_final_1/net-epoch-10.mat'];
        else
